...
const activeTradeProposals = await sdk.ledger.acs.readJsContracts({
    templateIds: [
        '#splice-token-test-trading-app:Splice.Testing.Apps.TradingApp:OTCTradeProposal',
    ],
...
const activeTradeProposals2 = await sdk.ledger.acs.readJsContracts({
    templateIds: [
        '#splice-token-test-trading-app:Splice.Testing.Apps.TradingApp:OTCTradeProposal',
    ],
...
const otcTrades = await sdk.ledger.acs.readJsContracts({
    templateIds: [
