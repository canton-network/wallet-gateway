...
| `check-migration-lock` | Test SQL migration immutability     | Conditional                                             | None                                                               | `yarn nx affected -t migrations:check-lock  --base=origin/${{ github.base_ref }} --head=HEAD --parallel`                 |
